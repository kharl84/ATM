...
class Account:
   ...
   # Account objectives, defining what it should do.
    def __init__(self, id, balance = 0, withdrawalDailyMax = 50000,
    withdrawalFrequency=3,withdrwalTransactionMax=20000, depositDailyMax = 160000, 
    depositFrequency = 4, depositTransactionMax = 40000):
        
     #Accouont self
        self.id = id
        self.balance = balance
      
     # withdral objectives defined
    ...
    # deposit objectives defined
        self.depositDailyMax=depositDailyMax
        self.depositFrequency = depositFrequency
        self.depositTransactionMax=depositTransactionMax

#A fuction to login, give access or simply verification 
    def getId(self):
        return self.id
...
#A function for deposit
    def getDepoDailyMax(self):
        return self.depositDailyMax
    def getDepositFrequency(self):
        return self.depositFrequency
    def getDepoTransactionMax(self):
        return self.depositTransactionMax

#  I have defined a function to withdraw
    def withdraw(self, amount):

# The balance get diducted here if you withdraw your new balance changes
        self.balance -= amount
...
#A function to interact with the account
def main():
    # Creating accounts 
    accounts = []
